# Planted Contradictions
                ...
                **Location B:** `regulations.pdf` → Page 2 → Medical Attendance Regulation
                ...
                **Location B:** `regulations.pdf` → Page 3 → Course Attempts Regulation
                ...
                **Conflict:** This pair intentionally appears consistent in wording but is used as a control case. The actual third contradiction is introduced below.

                **Location C:** `rulebook.md` → Section 21: Academic Progression

                > A failed course must normally be completed or otherwise resolved according to the applicable academic rules before a student can satisfy the corresponding degree requirement.

                **Note:** The corpus generator may be extended with an explicit three-attempt clause if needed. For this submission, the primary planted contradictions are the attendance and fee conflicts plus the deliberately inconsistent attempt interpretation between course-level and general regulations.
